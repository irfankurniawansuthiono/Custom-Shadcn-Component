...
function SelectTrigger({
  ...
  // Fungsi untuk menghentikan propagasi dan memanggil onReset
  const handleResetClick = (e: React.MouseEvent) => {
    e.stopPropagation(); // Menghentikan propagasi event ke atas
    if (onReset) {
      onReset();
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        {children}
        <SelectPrimitive.Icon className={cn("absolute right-2", !props.value && "pointer-events-none")}>
          {props.value ? (
            <div 
